...
Slanted WordPress Theme, Copyright 2018 AlxMedia
Slanted is distributed under the terms of the GNU GPL
...
Slanted bundles the following third-party resources:
...
* Fixed post-nav default position now in the sidebar
...
* Changed function names from alx_ to slanted_
